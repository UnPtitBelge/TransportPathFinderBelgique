...
public class RouteParser {
    ...
    private static final List<String> PATHS = List.of(
        "src/main/resources/GTFS/DELIJN/routes.csv",
        "src/main/resources/GTFS/SNCB/routes.csv",
        "src/main/resources/GTFS/STIB/routes.csv",
        "src/main/resources/GTFS/TEC/routes.csv"
    );
